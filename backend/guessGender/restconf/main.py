...
REST_FRAMEWORK = {
    ...
    'DEFAULT_PAGINATION_CLASS' : 'guessGender.restconf.pagination.CFEAPIPagination',
...
JWT_AUTH = {
    ...
    # 'rest_framework_jwt.utils.jwt_response_payload_handler', #Custom JWT Response Payload Handler
